...
RUN apk upgrade --no-cache && apk add --no-cache curl libexpat tar python3 jq unzip zip procps bash fontconfig libretls musl-locales musl-locales-lang ttf-dejavu tzdata zlib libc6-compat gcompat\
    && rm -rf /var/cache/apk/*
